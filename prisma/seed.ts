...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      nameAr: "لبن المراعي قليل الدسم 1 لتر",
      brand: "Almarai",
      categorySlug: "dairy",
    ...
    },
    {
      ...
      nameAr: "شيبسي عائلي ملح وخل 170 جم",
      brand: "Chipsy",
      categorySlug: "snacks",
    ...
    {
      sku: "EG-SN-003",
      barcode: "6223001010103",
      nameAr: "ويفر كورونا شوكولاتة",
      brand: "Corona",
      categorySlug: "snacks",
    ...
    {
      sku: "EG-SN-004",
      barcode: "6223001010104",
      nameAr: "سوداني محمص فاخر 200 جم",
      brand: "Private Label",
      categorySlug: "snacks",
    ...
    {
      sku: "EG-BV-003",
      barcode: "6223001010203",
      nameAr: "مياه أكوافينا 600 مل",
      brand: "Aquafina",
      categorySlug: "beverages",
    ...
    {
      sku: "EG-BV-004",
      barcode: "6223001010204",
      nameAr: "عصير بيتي مانجو 1 لتر",
      brand: "Beyti",
      categorySlug: "beverages",
    ...
    },
    {
      ...
      nameAr: "خضار مشكل مجمد 400 جم",
      brand: "بسمة",
      categorySlug: "frozen",
      imageUrl: "https://images.unsplash.com/photo-1615485925873-0f87f8f5f3f7?auto=format&fit=crop&w=900&q=80",
      costPrice: 24,
      salePrice: 31,
      stockQty: 27,
      lowStockThreshold: 8,
    ...
    {
      sku: "EG-FR-002",
      barcode: "6223001010402",
      nameAr: "برجر بقري مجمد 1 كجم",
      brand: "Halwani",
      categorySlug: "frozen",
      imageUrl: "https://images.unsplash.com/photo-1603046891744-9f76eb10aec4?auto=format&fit=crop&w=900&q=80",
      costPrice: 130,
      salePrice: 156,
      stockQty: 14,
      lowStockThreshold: 5,
    ...
    {
      sku: "EG-FR-003",
      barcode: "6223001010403",
      nameAr: "بطاطس نصف مقلية 1 كجم",
      brand: "Farm Frites",
      categorySlug: "frozen",
    ...
    },
    {
      ...
      nameAr: "برسيل جل للغسالات 2.5 لتر",
      brand: "Persil",
      categorySlug: "cleaning",
      imageUrl: "https://images.unsplash.com/photo-1583947582886-f40ec95dd752?auto=format&fit=crop&w=900&q=80",
      costPrice: 148,
      salePrice: 175,
      stockQty: 19,
      lowStockThreshold: 5,
    ...
    {
      sku: "EG-CL-002",
      barcode: "6223001010502",
      nameAr: "كلوركس 950 مل",
      brand: "Clorox",
      categorySlug: "cleaning",
    ...
    {
      sku: "EG-CL-003",
      barcode: "6223001010503",
      nameAr: "فاين مناديل مطبخ رول كبير",
      brand: "Fine",
      categorySlug: "cleaning",
      imageUrl: "https://images.unsplash.com/photo-1583251633146-d0c6c36f0b0f?auto=format&fit=crop&w=900&q=80",
      costPrice: 39,
      salePrice: 49,
      stockQty: 17,
      lowStockThreshold: 7,
    ...
    {
      sku: "EG-GR-003",
      barcode: "6223001010603",
      nameAr: "سكر أبيض 1 كجم",
      brand: "Local",
      categorySlug: "grocery",
      imageUrl: "https://images.unsplash.com/photo-1581441363689-1f3c3c414635?auto=format&fit=crop&w=900&q=80",
      costPrice: 29,
      salePrice: 36,
      stockQty: 53,
      lowStockThreshold: 10,
    ...
    {
      sku: "EG-GR-004",
      barcode: "6223001010604",
      nameAr: "زيت عباد الشمس عافية 700 مل",
      brand: "Afia",
      categorySlug: "grocery",
